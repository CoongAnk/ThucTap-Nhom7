      ...
      <section className="explore-dark">
        ...
        <details>
          ...
          <div className="explore-content">
            <img src="/images/explore-math.jpg" alt="M1" />
        ...
        <details>
          ...
          <div className="explore-content">
            <img src="/images/explore-science.jpg" alt="M2" />
        ...
        <details>
          ...
          <div className="explore-content">
            <img src="/images/explore-life.jpg" alt="M3" />
        ...
        <details>
          ...
          <div className="explore-content">
            <img src="/images/explore-cs.jpg" alt="M4" />
        ...
        <details>
          ...
          <div className="explore-content">
            <img src="/images/explore-teacher.jpg" alt="M5" />
